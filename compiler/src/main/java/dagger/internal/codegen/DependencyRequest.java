...
abstract class DependencyRequest {
  ...
  static final class Factory {
    ...
    DependencyRequest forFactoryMembersInjector(TypeElement type) {
      checkNotNull(type);
      DeclaredType membersInjectorType = types.getDeclaredType(
          elements.getTypeElement(MembersInjector.class.getCanonicalName()), type.asType());
      return newDependencyRequest(type, membersInjectorType, Optional.<AnnotationMirror>absent());
    }
