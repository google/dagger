...
_deploy \
  ...
  dagger-compiler/main/java/dagger/internal/codegen/artifact.jar \
  dagger-compiler/main/java/dagger/internal/codegen/pom.xml \
  dagger-compiler/main/java/dagger/internal/codegen/artifact-src.jar \
  dagger-compiler/main/java/dagger/internal/codegen/artifact-javadoc.jar \
  ""
