 ...
 * level, as described in {@link android.Application#onTrimMemory(int)}.
 *
 * <p>For example:
 *
 * <pre>
 ...
 * AndroidMemorySensitiveReferenceManager} into your {@link android.Application} and delegate {@link
 * android.Application#onTrimMemory(int)} to it.
 */
@Documented
@GwtIncompatible
